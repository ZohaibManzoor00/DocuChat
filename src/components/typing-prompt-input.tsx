...
export default function TypingPromptInput() {
  const prompts = [
    "Can you summarize this textbook chapter for my study notes?",
    "What are the key financial insights from this quarterly report?",
    "Could you explain what this document says in simple English?",
    "Find the main arguments and evidence in this research paper...",
    "Extract the important requirements from this legal document...",
  ]
    ...
    <div className="relative w-full max-w-2xl mx-auto">
      <div className="relative group">
        ...
        <div className="relative">
          <Input
            className="pr-20 py-4 text-base rounded-xl backdrop-blur-md border-2 focus-visible:ring-0 focus-visible:ring-offset-0 
